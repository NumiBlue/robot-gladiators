...
var fightOrSkip = function() {
  ...
  if (promptFight === "" || promptFight === null) {
    ...
    //use return to call it again and stop
    return fightOrSkip();
  }
  ...
  promptFight = promptFight.toLowerCase();
    ...
    if (confirmSkip) {
      ...
      //return true if players wants to leave
      return true;
    }
  }
  return false;
...
var startGame = function() {
  ...
  for (var i = 0; i < enemyInfo.length; i++) {
   ...
   if (playerInfo.health > 0) {
     //let player know what round they are in, remember that arrays start at 0, so it needs to have 1 added
    ...
    if (playerInfo.health > 0 && i < enemyInfo.length - 1) {
      ...
      var storeComfirm = window.confirm("The fight is over, visit the store before the next round?");
  ...
  //if the player is not alive, break out of the loop and let endGame function run 
 else {
...
//go to shop between batt;es function
var shop = function () {
 ...
 shopOptionPromt = parseInt(shopOptionPrompt);
